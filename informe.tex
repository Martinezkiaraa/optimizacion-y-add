...
implementamos en \texttt{Python} una función que resuelve este sistema utilizando el método de eliminación por Gauss. 
...
\[
\lambda_1=0.524,\qquad
\lambda_2=3.471,\qquad
\lambda_3=385.005.
\]
...
\sigma_1=19.622,\;\;\sigma_2=1.863,\;\;\sigma_3=0.724.
\]
...
Los vectores propios normalizados de \(A^{\mathsf T}A\) asociados a \(\lambda_3,\lambda_2,\lambda_1\) (ordenados para que coincidan con \(\sigma_1\ge\sigma_2\ge\sigma_3\)) forman las columnas de \(V\).
...
V=
\begin{bmatrix}
-0.083 & \phantom{-}0.789 & \phantom{-}0.608\\
-0.272 & \phantom{-}0.569 & -0.776\\
-0.959 & -0.23 & \phantom{-}0.168
\end{bmatrix}
\]
...
U=
\begin{bmatrix}
-0.004 & \phantom{-}0.424 & \phantom{-}0.840 & -0.026 & -0.337\\
-0.067 & \phantom{-}0.606 & \phantom{-}0.000 & \phantom{-}0.281 & \phantom{-}0.741\\
-0.227 & \phantom{-}0.541 & -0.376 & -0.688 & -0.202\\
-0.486 & \phantom{-}0.229 & -0.288 & \phantom{-}0.637 & -0.472\\
-0.841 & -0.329 & \phantom{-}0.264 & -0.204 & \phantom{-}0.27
\end{bmatrix}
\]
...
\begin{align*}
u_1\!\cdot\! u_2 &= (-0.004)(0.424)+(-0.067)(0.606)+(-0.227)(0.541)\\
&\quad+(-0.486)(0.229)+(-0.841)(-0.329)
= -3.73\times 10^{-7}\approx 0.\\[6pt]
u_1\!\cdot\! u_3 &= (-0.004)(0.840)+(-0.067)(0.000)+(-0.227)(-0.376)\\
&\quad+(-0.486)(-0.288)+(-0.841)(0.264)
= 6.77\times 10^{-8}\approx 0.\\[6pt]
u_1\!\cdot\! u_4 &= (-0.004)(-0.026)+(-0.067)(0.281)+(-0.227)(-0.688)\\
&\quad+(-0.486)(0.637)+(-0.841)(-0.204)
= -4.59\times 10^{-7}\approx 0.\\[6pt]
u_1\!\cdot\! u_5 &= (-0.004)(-0.337)+(-0.067)(0.741)+(-0.227)(-0.202)\\
&\quad+(-0.486)(-0.472)+(-0.841)(0.27)
= -3.67\times 10^{-8}\approx 0.\\[10pt]
u_2\!\cdot\! u_3 &= (0.424)(0.840)+(0.606)(0.000)+(0.541)(-0.376)\\
&\quad+(0.229)(-0.288)+(-0.329)(0.264)
= 7.25\times 10^{-7}\approx 0.\\[6pt]
u_2\!\cdot\! u_4 &= (0.424)(-0.026)+(0.606)(0.281)+(0.541)(-0.688)\\
&\quad+(0.229)(0.637)+(-0.329)(-0.204)
= -2.04\times 10^{-7}\approx 0.\\[6pt]
u_2\!\cdot\! u_5 &= (0.424)(-0.337)+(0.606)(0.741)+(0.541)(-0.202)\\
&\quad+(0.229)(-0.472)+(-0.329)(0.27)
= 5.17\times 10^{-7}\approx 0.\\[10pt]
u_3\!\cdot\! u_4 &= (0.840)(-0.026)+(0.000)(0.281)+(-0.376)(-0.688)\\
&\quad+(-0.288)(0.637)+(0.264)(-0.204)
= -2.81\times 10^{-7}\approx 0.\\[6pt]
u_3\!\cdot\! u_5 &= (0.840)(-0.337)+(0.000)(0.741)+(-0.376)(-0.202)\\
&\quad+(-0.288)(-0.472)+(0.264)(0.27)
= -1.205\times 10^{-6}\approx 0.\\[6pt]
u_4\!\cdot\! u_5 &= (-0.026)(-0.337)+(0.281)(0.741)+(-0.688)(-0.202)\\
&\quad+(0.637)(-0.472)+(-0.204)(0.27)
...
\[
\sigma_1 \approx 19.622, \qquad
\sigma_2 \approx 1.863, \qquad
\sigma_3 \approx 0.724,
\]
...
\begin{figure}[H]
    \centering
        \includegraphics[width=0.7\linewidth]{curvas_de_nivel.png}
...
\begin{figure}[H]
    \centering
        \includegraphics[width=0.7\linewidth]{función_Q(b1,b2).png}
...
Para valores mayores, el gradiente crece sin control y la iteración diverge, lo que se refleja en la aparición de valores \texttt{nan}. Esto ilustra la sensibilidad del descenso por gradiente a la elección de la tasa de aprendizaje.

\begin{figure}[H]
    \centering
        \includegraphics[width=0.7\linewidth]{eta_dg.png}
...
\[
\mathrm{MSE}_{\mathrm{NE}} \approx 1.829\times 10^{-3},\quad
\mathrm{MSE}_{\mathrm{SVD}} \approx 1.829\times 10^{-3},\quad
\mathrm{MSE}_{\mathrm{GD}} \approx 1.829\times 10^{-3}.
\]
...
La descomposición \(A=U\Sigma V^{\mathsf T}\) proporciona una forma numéricamente robusta de resolver problemas de mínimos cuadrados, ya que \(A^{+}=V\Sigma^{+}U^{\mathsf T}\).
...
Partimos de las variables numéricas (\texttt{Age}, \texttt{Years\_of\_experience}) y de las variables categóricas (\texttt{Gender}, \texttt{Education\_level}, \texttt{Job\_title}). Tratamos las variables categóricas, obteniendo una matriz de diseño
...
La inclusión de un número elevado de variables binarias indicadoras genera alta colinealidad en la matriz de diseño. El número de condición estimado para $A_{\mathrm{train}}$ es
...
\begin{figure}[h]
    \centering
        \includegraphics[width=0.85\textwidth]{predicción_vs_real.png}
